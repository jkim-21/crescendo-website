...
const UnmatchedTable = ({ unmatchedMentees, unmatchedMentors }) => {
  return (
    <div className="unmatched w-full max-w-5xl bg-white p-8 rounded-lg shadow-lg mt-8 overflow-hidden">
      ...
      {unmatchedMentees.length > 0 || unmatchedMentors.length > 0 ? (
        <div className="overflow-x-auto">
          <table className="pairings-table w-full border-collapse mt-4 min-w-max">
            <thead>
              <tr>
