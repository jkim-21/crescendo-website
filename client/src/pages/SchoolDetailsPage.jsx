...
const SchoolDetailsPage = () => {
  ...
  //stuff for saving schools: useeffect:checksavedstatus handlesave
  ...
  //stuff for page data: useeffect:fetchdata
  ...
  //stuff for backbutton: handleback
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg w-96">
            ...
            >
              ...
              <option value="Other">Other wacky weird strange option</option>
            </select>
            <textarea
              value={reportMessage}
